...
Software engineering student at USTHB, Algiers (4th year), focused on backend development — API design, database architecture, and the systems underneath an application.
